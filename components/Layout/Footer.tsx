...
const Footer = () => {
	...
	return (
		<footer className='bg-black pt-32 relative text-xs sm:text-sm'>
			<div className='flex flex-col items-center gap-8'>
						...
						{links.map((link, i) => (
							<li
								...
								className={`px-5 sm:px-10 ${
									i === links.length - 1 ? "border-none" : "border-r-2 border-slate-400"
								}`}>
				...
				<a href='https://www.instagram.com/xunwang2000/' target='_blank' rel='noopener noreferrer'>
					<div className='flex gap-2'>
						<Image className='opacity-70' src={instagramIcon} alt='instagram' />
						{t("xun wang instagram")}
					</div>
				</a>
			</div>
			<div className='flex justify-between items-end py-20 px-10'>
				<Image src={SignatureImg} alt="xun wang's signature" width={150} height={80} />
