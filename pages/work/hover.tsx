...
import imageOne from "../../public/images/works/hover/1.jpg";
import imageTwo from "../../public/images/works/hover/2.jpg";
import imageThree from "../../public/images/works/hover/3.jpg";

const name = "hover";
const translationPath = "workHover";
