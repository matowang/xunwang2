...
const Home: NextPage = () => {
	return (
		<>
			...
			<section className='absolute top-0 left-0 w-full h-screen grid sm:grid-cols-2 justify-items-start align-end sm:flex-row sm:justify-between items-end p-10 sm:p-20'>
			...
			<section className='items-center grid grid-cols-2 max-w-7xl mx-auto gap-10 px-5 py-96'>
				<div className=''>
